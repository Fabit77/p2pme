...
async function multicall(client, parameters) {
  const { account: account2, authorizationList, allowFailure = true, blockNumber, blockOverrides, blockTag, stateOverride } = parameters;
...
// tools/fondo-integrator-deployer/artifact.json
var artifact_default = { abi: [{ inputs: [{ internalType: "address", name: "_diamond", type: "address" }, { internalType: "address", name: "_usdc", type: "address" }, { internalType: "address", name: "_treasury", type: "address" }, { internalType: "uint256", name: "_maxTxAmount", type: "uint256" }, { internalType: "uint256", name: "_dailyTxCountLimit", type: "uint256" }], stateMutability: "nonpayable", type: "constructor" }, { inputs: [], name: "CloneArgumentsTooLong", type: "error" }, { inputs: [], name: "Create2EmptyBytecode", type: "error" }, { inputs: [], name: "DuplicateOrderId", type: "error" }, { inputs: [], name: "FailedDeployment", type: "error" }, { inputs: [{ internalType: "uint256", name: "balance", type: "uint256" }, { internalType: "uint256", name: "needed", type: "uint256" }], name: "InsufficientBalance", type: "error" }, { inputs: [], name: "InvalidAddress", type: "error" }, { inputs: [], name: "InvalidAmount", type: "error" }, { inputs: [], name: "InvalidLimit", type: "error" }, { inputs: [], name: "LimitExceedsCeiling", type: "error" }, { inputs: [], name: "MissingValidation", type: "error" }, { inputs: [], name: "OnlyDiamond", type: "error" }, { inputs: [], name: "OnlyOwner", type: "error" }, { inputs: [], name: "OrderAlreadyCancelled", type: "error" }, { inputs: [], name: "OrderAlreadyFulfilled", type: "error" }, { inputs: [], name: "OrderMismatch", type: "error" }, { inputs: [], name: "PlacementInProgress", type: "error" }, { inputs: [], name: "ReentrancyGuardReentrantCall", type: "error" }, { inputs: [{ internalType: "address", name: "token", type: "address" }], name: "SafeERC20FailedOperation", type: "error" }, { inputs: [], name: "UnexpectedValidation", type: "error" }, { inputs: [], name: "UnknownOrder", type: "error" }, { inputs: [], name: "ValidationMismatch", type: "error" }, { anonymous: false, inputs: [{ indexed: false, internalType: "uint256", name: "count", type: "uint256" }], name: "DailyTxCountLimitUpdated", type: "event" }, { anonymous: false, inputs: [{ indexed: false, internalType: "uint256", name: "amount", type: "uint256" }], name: "MaxTxAmountUpdated", type: "event" }, { anonymous: false, inputs: [{ indexed: true, internalType: "uint256", name: "orderId", type: "uint256" }, { indexed: true, internalType: "address", name: "user", type: "address" }], name: "OrderCancelled", type: "event" }, { anonymous: false, inputs: [{ indexed: true, internalType: "uint256", name: "orderId", type: "uint256" }, { indexed: true, internalType: "address", name: "user", type: "address" }, { indexed: false, internalType: "uint256", name: "amount", type: "uint256" }, { indexed: true, internalType: "address", name: "treasury", type: "address" }], name: "OrderCompleted", type: "event" }, { anonymous: false, inputs: [{ indexed: true, internalType: "uint256", name: "orderId", type: "uint256" }, { indexed: true, internalType: "address", name: "user", type: "address" }, { indexed: false, internalType: "uint256", name: "amount", type: "uint256" }, { indexed: true, internalType: "bytes32", name: "currency", type: "bytes32" }], name: "OrderPlaced", type: "event" }, { anonymous: false, inputs: [{ indexed: false, internalType: "uint256", name: "amount", type: "uint256" }, { indexed: true, internalType: "address", name: "treasury", type: "address" }], name: "StrandedUsdcRecovered", type: "event" }, { anonymous: false, inputs: [{ indexed: true, internalType: "address", name: "user", type: "address" }, { indexed: false, internalType: "address", name: "proxy", type: "address" }], name: "UserProxyDeployed", type: "event" }, { inputs: [], name: "MAX_DAILY_TX_COUNT_LIMIT", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" }, { inputs: [], name: "MAX_TX_AMOUNT_CEILING", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" }, { inputs: [], name: "dailyTxCountLimit", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" }, { inputs: [], name: "diamond", outputs: [{ internalType: "address", name: "", type: "address" }], stateMutability: "view", type: "function" }, { inputs: [{ internalType: "address", name: "user", type: "address" }], name: "getRemainingDailyCount", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" }, { inputs: [], name: "maxTxAmount", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" }, { inputs: [{ internalType: "uint256", name: "orderId", type: "uint256" }], name: "onOrderCancel", outputs: [], stateMutability: "nonpayable", type: "function" }, { inputs: [{ internalType: "uint256", name: "orderId", type: "uint256" }, { internalType: "address", name: "user", type: "address" }, { internalType: "uint256", name: "amount", type: "uint256" }, { internalType: "address", name: "recipientAddr", type: "address" }], name: "onOrderComplete", outputs: [], stateMutability: "nonpayable", type: "function" }, { inputs: [], name: "owner", outputs: [{ internalType: "address", name: "", type: "address" }], stateMutability: "view", type: "function" }, { inputs: [{ internalType: "address", name: "user", type: "address" }], name: "proxyAddress", outputs: [{ internalType: "address", name: "", type: "address" }], stateMutability: "view", type: "function" }, { inputs: [], name: "proxyImpl", outputs: [{ internalType: "address", name: "", type: "address" }], stateMutability: "view", type: "function" }, { inputs: [], name: "recoverStrandedUsdc", outputs: [], stateMutability: "nonpayable", type: "function" }, { inputs: [{ internalType: "uint256", name: "", type: "uint256" }], name: "sessions", outputs: [{ internalType: "address", name: "user", type: "address" }, { internalType: "bool", name: "fulfilled", type: "bool" }, { internalType: "bool", name: "cancelled", type: "bool" }, { internalType: "uint32", name: "placementDay", type: "uint32" }, { internalType: "uint256", name: "usdcAmount", type: "uint256" }, { internalType: "bytes32", name: "currency", type: "bytes32" }], stateMutability: "view", type: "function" }, { inputs: [{ internalType: "uint256", name: "count", type: "uint256" }], name: "setDailyTxCountLimit", outputs: [], stateMutability: "nonpayable", type: "function" }, { inputs: [{ internalType: "uint256", name: "amount", type: "uint256" }], name: "setMaxTxAmount", outputs: [], stateMutability: "nonpayable", type: "function" }, { inputs: [], name: "treasury", outputs: [{ internalType: "address", name: "", type: "address" }], stateMutability: "view", type: "function" }, { inputs: [], name: "usdc", outputs: [{ internalType: "contract IERC20", name: "", type: "address" }], stateMutability: "view", type: "function" }, { inputs: [{ internalType: "address", name: "", type: "address" }, { internalType: "uint256", name: "", type: "uint256" }], name: "userDailyCount", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" }, { inputs: [{ internalType: "uint256", name: "amount", type: "uint256" }, { internalType: "bytes32", name: "currency", type: "bytes32" }, { internalType: "uint256", name: "circleId", type: "uint256" }, { internalType: "string", name: "pubKey", type: "string" }, { internalType: "uint256", name: "preferredPaymentChannelConfigId", type: "uint256" }, { internalType: "uint256", name: "fiatAmountLimit", type: "uint256" }], name: "userPlaceOrder", outputs: [{ internalType: "uint256", name: "orderId", type: "uint256" }], stateMutability: "nonpayable", type: "function" }, { inputs: [{ internalType: "address", name: "user", type: "address" }, { internalType: "uint256", name: "amount", type: "uint256" }, { internalType: "bytes32", name: "currency", type: "bytes32" }], name: "validateOrder", outputs: [{ internalType: "bool", name: "allowed", type: "bool" }], stateMutability: "nonpayable", type: "function" }], bytecode: "" };

// tools/fondo-integrator-deployer/main.ts
var DIAMOND = getAddress("0xeb0BB8E3c014D915D9B2df03aBB130a1Fb44beb9");
var USDC = getAddress("0x4095fE4f1E636f11A95820BA2bB87F335Bd1040d");
var TREASURY = getAddress("0xA3B2BD9d16030d31b82B3E5a084f1A736ed9F769");
var EXPECTED_DEPLOYER = getAddress("0x77E2e22055b915ba0244933E8459ba73F0571883");
var EXISTING_INTEGRATOR = getAddress("0x82Ec641720dA381C88aB351f9bDA4edfa06e9aeA");
var EXISTING_TX = "0x276df3168467f2817eca7c8d6bad1ebc4e9b1cbced3b94a13b2decdfa6de805b";
var MAX_TX_AMOUNT = parseUnits("1000", 6);
var DAILY_TX_COUNT_LIMIT = 100n;
var connectButton = document.querySelector("#connect");
var deployButton = document.querySelector("#deploy");
...
async function verifyDeployment(publicClient, contractAddress, hash3) {
  for (let attempt = 0; attempt < 12; attempt += 1) {
    ...
    if (bytecode && bytecode !== "0x") {
      const [storedTreasury, proxyImpl] = await Promise.all([
        publicClient.readContract({ address: contractAddress, abi: artifact_default.abi, functionName: "treasury" }),
        publicClient.readContract({ address: contractAddress, abi: artifact_default.abi, functionName: "proxyImpl" })
      ]);
      if (getAddress(storedTreasury) !== TREASURY) throw new Error("La tesorer\xEDa verificada no coincide.");
      return { storedTreasury, proxyImpl };
    }
    await new Promise((resolve) => setTimeout(resolve, 2500));
  }
  throw new Error(`El contrato fue confirmado en ${hash3}, pero el RPC todav\xEDa no entrega su c\xF3digo. Espera unos segundos y recarga; no vuelvas a desplegar.`);
}
...
connectButton.addEventListener("click", async () => {
  try {
    if (!window.ethereum) throw new Error("MetaMask no est\xE1 instalado en este navegador.");
...
deployButton.addEventListener("click", async () => {
  ...
  try {
    setStatus("MetaMask abrir\xE1 la confirmaci\xF3n. Revisa Base Sepolia y el costo de gas antes de firmar.");
    const hash3 = await walletClient.deployContract({
      account,
      chain: baseSepolia,
      abi: artifact_default.abi,
      bytecode: artifact_default.bytecode,
      args: [DIAMOND, USDC, TREASURY, MAX_TX_AMOUNT, DAILY_TX_COUNT_LIMIT]
    });
    localStorage.setItem("fondoDeploymentHash", hash3);
    setStatus(`Transacci\xF3n enviada: ${hash3}
Esperando confirmaci\xF3n\u2026`);
    const publicClient = createPublicClient({ chain: baseSepolia, transport: http("https://sepolia.base.org") });
    const receipt = await publicClient.waitForTransactionReceipt({ hash: hash3, confirmations: 1 });
    if (receipt.status !== "success" || !receipt.contractAddress) throw new Error("El despliegue fue revertido.");
    const { storedTreasury, proxyImpl } = await verifyDeployment(publicClient, receipt.contractAddress, hash3);
    setStatus(
