...
export function DashboardShell({ children, accountName = "Cuenta demo", email = "Cuenta demo", live = false, platformAdmin = false, canCreateCampaign = true, canManageOrganization = true }: { children: React.ReactNode; accountName?: string; email?: string; live?: boolean; platformAdmin?: boolean; canCreateCampaign?: boolean; canManageOrganization?: boolean }) {
  ...
  const links = [
    ...
    { href: "/dashboard/settings", label: "Configuración", icon: Settings, visible: true },
  ];
