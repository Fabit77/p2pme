...
export function DashboardShell({ children, organizationName = "Club Los Andes", email = "Cuenta demo", live = false }: { children: React.ReactNode; organizationName?: string; email?: string; live?: boolean }) {
